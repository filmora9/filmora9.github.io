$(function($){
    ...
    var getuserInfo=function(data,callback){
        var url='//effects.wondershare.com/fr/api/user/profile?jsonp=1';
        $.ajax({
            url:url,
            type:'get',
            data:data,
    ...
    var loginShow=function(flag){
        ...
        $("#login").append("<iframe id='iframe-login' width='100%'' height='100%' frameborder='0' src='//effects.wondershare.com/fr/login.html?from_product=1#"+flag+"'></iframe>");
    };
    ...
    $('.logout>a').attr('href','//effects.wondershare.com/fr/user/login-out.html?redirect='+window.location.href);

    var third_url={
        'google_login_url':'https://account.wondershare.com/google/connect?brand=filmora&platform=web&callback=sync&web=filmora.wondershare.com/fr&redirect=https://effects.wondershare.com/fr/synch-login.html?redirect='+window.location.href,
        'facebook_login_url':'https://account.wondershare.com/facebook/connect?brand=filmora&platform=web&callback=sync&web=filmora.wondershare.com/fr&redirect=https://effects.wondershare.com/fr/synch-login.html?redirect='+window.location.href,
        'twitter_login_url':'https://account.wondershare.com/twitter/connect?brand=filmora&platform=web&callback=sync&web=filmora.wondershare.com/fr&redirect=https://effects.wondershare.com/fr/synch-login.html?redirect='+window.location.href
    }
